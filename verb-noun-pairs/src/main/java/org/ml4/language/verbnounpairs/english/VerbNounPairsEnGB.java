...
public class VerbNounPairsEnGB {
    ...
    public final static SortedMap<WordDefinitionId, VerbNounPair> ALL_VERB_NOUN_PAIRS = new VerbNounPairCSVReader(false, VERB_NOUN_PAIRS_NOUNS_ENDING_WITH_ON_MAPPINGS_FILE_PATH).load();
