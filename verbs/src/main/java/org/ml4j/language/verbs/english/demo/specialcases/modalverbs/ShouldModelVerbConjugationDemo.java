...
public class ShouldModelVerbConjugationDemo {
    ...
    public static void main(String[] args) {
        ...
        VerbConjugation iRegularVerbConjugation = VerbConjugators.IRREGULAR_VERB_CONJUGATOR.getConjugatedVerb(EnglishWordsEnGB.ALL_IRREGULAR_VERBS.get(WordDefinitionId.create("should", 1)));
