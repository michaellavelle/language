...
public class EnGBAdjectiveAdverbMapperStartingWithLTest extends AdjectiveAdverbMapperTestBase {

    @Test
    public void testAdjectiveAdverbMapping() {
        testAdjectiveAdverbMapping(EnglishAdjectiveAdverbPairsEnGB.ADJECTIVES_STARTING_WITH_L, EnglishAdjectiveAdverbPairsEnGB.ADVERBS_STARTING_WITH_L, EXPECTED_ADJECTIVE_ADVERB_PAIRS_STARTING_WITH_L_FILE_PATH);
    }
